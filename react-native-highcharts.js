...
class ChartWeb extends Component {
  ...
  static getChartHtml = (isStockChart, chartOptions) => (
    `
    <html>
      ...
      <head>
          ...
          <script>
            $(function () {
                Highcharts.${isStockChart ? 'stockChart' : 'chart'}('container', ${chartOptions});
            });
          </script>
      </head>
      <body>
  ...
  render() {
    ...
    const chartHtml = ChartWeb.getChartHtml(this.props.stock, flattenObject(config));

    return (
      <View style={this.props.style}>
        <WebView
          onLayout={(event) => this.reRenderWebView(event)}
          style={styles.full}
          source={{html: chartHtml, baseUrl: 'web/'}}
